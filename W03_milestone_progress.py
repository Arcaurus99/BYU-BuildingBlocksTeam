...
def mealPriceCalculator():
    ...
    var_ch_meal = float(input("Insert the price of a child's meal: "))
    var_ad_meal = float(input("Insert the price of an adult's meal: "))
    var_ch_drink = float(input("Insert the price of a child's drink: "))
    var_ad_drink = float(input("Insert the price of an adult's drink: "))
    var_ch_num = int(input("Insert the number of children: "))
    var_ad_num = int(input("Insert the number of adults: "))
    var_tax_rate = float(input("Insert the sales tax rate: "))

    print("\n")         # <br> :D

    var_ch_total = (var_ch_meal * var_ch_num) + (var_ch_drink * var_ch_num)
    var_ad_total = (var_ad_meal * var_ad_num) + (var_ad_drink * var_ad_num)
    var_subtotal = var_ch_total + var_ad_total
